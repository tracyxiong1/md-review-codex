...
`md-review-codex` 是一个面向 Codex 文档评审循环的本地 Markdown 批注工具。它保留 `md-review` 的 Markdown 预览、选区评论、评论列表和文件树能力，并将评论存储迁移到 sidecar review 文件，同时提供本地 HTTP API 供 Codex 读取和回写评论状态。
...
```sh
md-review-codex [options]              # 浏览当前目录下的 Markdown 文件
md-review-codex <file> [options]       # 预览单个 Markdown 文件
md-review-codex <directory> [options]  # 浏览指定目录下的 Markdown 文件
```
...
```sh
md-review-codex
md-review-codex docs
md-review-codex README.md
md-review-codex docs/guide.mdx
md-review-codex docs --active-file docs/guide.md --port 8080
```
...
```sh
md-review-codex docs --port 3030 --active-file docs/guide.v2.md
```
